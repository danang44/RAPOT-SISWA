 ...
 * @author DANANG
 */
public class dataanaksd extends javax.swing.JFrame {

    /**
     * Creates new form dataanaksd
     */
    public dataanaksd() {
        initComponents();
    }

    public dataanaksd (String para){
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DATA RANKING SD");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(nama2, javax.swing.GroupLayout.PREFERRED_SIZE, 0, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dataanaksd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dataanaksd().setVisible(true);
            }
        });
    }
